...
const variantClasses = {
  ...
  outline:
    "border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:border-primary/35",
  secondary:
    ...
    return (
      <button
        className={cn(
          ...
          "[&_svg]:transition-transform [&_svg]:duration-200 hover:[&_svg]:translate-x-[3px]",
